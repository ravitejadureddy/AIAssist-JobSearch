...
> This file preserves the contributor list from the upstream [santifer/career-ops](https://github.com/santifer/career-ops) project. It documents the people who built the core CLI/skill framework that this fork ([ravitejadureddy/AIAssist-JobSearch](https://github.com/ravitejadureddy/AIAssist-JobSearch)) builds on. Contributions to this fork specifically are authored by [@ravitejadureddy](https://github.com/ravitejadureddy).
